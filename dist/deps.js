...
goog.addDependency(
	...
	['goog.asserts', 'shaka.abr.EwmaBandwidthEstimator', 'shaka.log', 'shaka.util.StreamUtils']
);
goog.addDependency(
...
goog.addDependency(
	...
	[
		...
		'shaka.media.Mp4SegmentIndexParser',
...
goog.addDependency(
	...
	['shaka.Deprecate'],
	['goog.asserts', 'shaka.deprecate.Enforcer', 'shaka.deprecate.Version']
);
...
goog.addDependency(
	...
	['shaka.hls.Attribute', 'shaka.hls.Playlist', 'shaka.hls.PlaylistType', 'shaka.hls.Segment', 'shaka.hls.Tag'],
	['goog.asserts']
);
goog.addDependency(
...
goog.addDependency(
	...
	['goog.asserts', 'shaka.util.MimeUtils']
);
goog.addDependency(
	'../../../lib/media/adaptation_set_criteria.js',
	['shaka.media.AdaptationSetCriteria', 'shaka.media.ExampleBasedCriteria', 'shaka.media.PreferenceBasedCriteria'],
	['shaka.media.AdaptationSet']
);
goog.addDependency('../../../lib/media/buffering_observer.js', ['shaka.media.BufferingObserver'], []);
goog.addDependency(
	'../../../lib/media/closed_caption_parser.js',
	['shaka.media.IClosedCaptionParser', 'shaka.media.MuxJSClosedCaptionParser', 'shaka.media.NoopCaptionParser'],
	[]
);
goog.addDependency(
...
goog.addDependency(
	...
	['shaka.media.ManifestParser'],
	['goog.Uri', 'goog.asserts', 'shaka.log', 'shaka.net.NetworkingEngine', 'shaka.util.Error', 'shaka.util.Platform']
);
goog.addDependency(
...
goog.addDependency(
	...
	['shaka.media.Mp4SegmentIndexParser'],
	['goog.asserts', 'shaka.log', 'shaka.media.SegmentReference', 'shaka.util.Error', 'shaka.util.Mp4Parser']
);
goog.addDependency(
	'../../../lib/media/period_observer.js',
	['shaka.media.PeriodObserver'],
	['shaka.media.IPlayheadObserver', 'shaka.util.Periods']
);
goog.addDependency(
	'../../../lib/media/play_rate_controller.js',
	['shaka.media.PlayRateController'],
	['goog.asserts', 'shaka.util.IReleasable', 'shaka.util.Timer']
);
goog.addDependency(
	'../../../lib/media/playhead.js',
	['shaka.media.MediaSourcePlayhead', 'shaka.media.Playhead', 'shaka.media.SrcEqualsPlayhead'],
	[
		'goog.asserts',
		'shaka.log',
		'shaka.media.GapJumpingController',
...
goog.addDependency(
	...
	['shaka.media.IPlayheadObserver', 'shaka.media.PlayheadObserverManager'],
	['shaka.util.IReleasable']
);
goog.addDependency(
	'../../../lib/media/presentation_timeline.js',
	['shaka.media.PresentationTimeline'],
	['goog.asserts', 'shaka.log', 'shaka.media.SegmentReference']
);
goog.addDependency(
...
goog.addDependency(
	...
	['shaka.media.SegmentIndex'],
	['goog.asserts', 'shaka.log', 'shaka.media.SegmentReference', 'shaka.util.IDestroyable']
);
goog.addDependency(
...
goog.addDependency(
	...
	['shaka.media.VideoWrapper', 'shaka.media.VideoWrapper.PlayheadMover'],
	['goog.asserts', 'shaka.log', 'shaka.util.EventManager', 'shaka.util.IReleasable', 'shaka.util.Timer']
);
goog.addDependency(
...
goog.addDependency(
	...
	['shaka.net.HttpPluginUtils'],
	['shaka.log', 'shaka.util.Error', 'shaka.util.StringUtils']
);
goog.addDependency(
...
goog.addDependency(
	...
	['shaka.net.NetworkingEngine', 'shaka.net.NetworkingEngine.PendingRequest'],
	[
		'goog.Uri',
		'goog.asserts',
		'shaka.net.Backoff',
...
goog.addDependency(
	...
	['goog.asserts', 'shaka.log', 'shaka.polyfill.register']
);
goog.addDependency(
	'../../../lib/polyfill/input_event.js',
	['shaka.polyfill.InputEvent'],
	['shaka.log', 'shaka.polyfill.register']
);
...
goog.addDependency(
	...
	['shaka.log', 'shaka.polyfill.register', 'shaka.util.MimeUtils', 'shaka.util.Platform']
);
goog.addDependency(
...
goog.addDependency(
	...
	['shaka.routing.Walker', 'shaka.routing.Walker.Implementation'],
	['goog.asserts', 'shaka.routing.Node', 'shaka.routing.Payload', 'shaka.util.IDestroyable']
);
...
goog.addDependency(
	...
	['shaka.text.TextEngine', 'shaka.text.TtmlTextParser', 'shaka.util.Error', 'shaka.util.Mp4Parser']
);
goog.addDependency(
...
goog.addDependency(
	...
	['shaka.text.SimpleTextDisplayer'],
	['goog.asserts', 'shaka.log', 'shaka.text.Cue']
);
goog.addDependency(
	'../../../lib/text/text_engine.js',
	['shaka.text.TextEngine'],
	['goog.asserts', 'shaka.text.Cue', 'shaka.util.Error', 'shaka.util.IDestroyable', 'shaka.util.MimeUtils']
);
goog.addDependency(
...
goog.addDependency(
	...
	['shaka.util.AbortableOperation'],
	['shaka.util.Error', 'shaka.util.PublicPromise']
);
...
goog.addDependency(
	...
	['shaka.util.DataViewReader'],
	['goog.asserts', 'shaka.util.Error', 'shaka.util.StringUtils']
);
...
goog.addDependency(
	...
	['shaka.util.EbmlElement', 'shaka.util.EbmlParser'],
	['shaka.util.DataViewReader', 'shaka.util.Error', 'shaka.util.Uint8ArrayUtils']
);
goog.addDependency('../../../lib/util/error.js', ['shaka.util.Error'], []);
goog.addDependency(
	'../../../lib/util/event_manager.js',
	['shaka.util.EventManager'],
	['goog.asserts', 'shaka.util.IReleasable', 'shaka.util.MultiMap']
);
goog.addDependency('../../../lib/util/fake_event.js', ['shaka.util.FakeEvent'], []);
goog.addDependency(
	'../../../lib/util/fake_event_target.js',
	['shaka.util.FakeEventTarget'],
	['goog.asserts', 'shaka.log', 'shaka.util.FakeEvent', 'shaka.util.MultiMap']
);
...
goog.addDependency(
	...
	['shaka.util.ManifestParserUtils'],
	['goog.Uri', 'shaka.util.Functional']
);
...
goog.addDependency(
	...
	['shaka.util.Mp4Parser'],
	['goog.asserts', 'shaka.log', 'shaka.util.DataViewReader']
);
...
goog.addDependency(
	...
	['shaka.util.OperationManager'],
	['shaka.util.ArrayUtils', 'shaka.util.IDestroyable']
);
...
goog.addDependency(
	...
	['shaka.util.PlayerConfiguration'],
	['shaka.abr.SimpleAbrManager', 'shaka.util.ConfigUtils']
);
goog.addDependency(
	'../../../lib/util/pssh.js',
	['shaka.util.Pssh'],
	['goog.asserts', 'shaka.log', 'shaka.util.Mp4Parser', 'shaka.util.Uint8ArrayUtils']
);
...
goog.addDependency(
	'../../../lib/util/stats.js',
	['shaka.util.Stats'],
	['shaka.util.StateHistory', 'shaka.util.SwitchHistory']
);
goog.addDependency(
...
goog.addDependency(
	'../../../ui/controls.js',
	['shaka.ui.Controls', 'shaka.ui.ControlsPanel'],
	[
		'goog.asserts',
		'shaka.log',
		'shaka.ui.Constants',
...
goog.addDependency(
	...
	['shaka.ui.Element', 'shaka.ui.Locales', 'shaka.ui.Localization', 'shaka.util.Dom']
);
goog.addDependency(
	'../../../ui/fullscreen_button.js',
	['shaka.ui.FullscreenButton'],
	['shaka.ui.Element', 'shaka.ui.Enums', 'shaka.ui.Locales', 'shaka.ui.Localization', 'shaka.util.Dom']
);
goog.addDependency(
	'../../../ui/language_utils.js',
	['shaka.ui.LanguageUtils'],
	['mozilla.LanguageMapping', 'shaka.util.Dom']
);
goog.addDependency(
	'../../../ui/localization.js',
	['shaka.ui.Localization', 'shaka.ui.Localization.ConflictResolution'],
	['shaka.util.FakeEvent', 'shaka.util.FakeEventTarget', 'shaka.util.Iterables', 'shaka.util.LanguageUtils']
);
goog.addDependency(
	'../../../ui/mute_button.js',
	['shaka.ui.MuteButton'],
...
goog.addDependency(
	...
	['shaka.ui.Element', 'shaka.util.Dom']
);
goog.addDependency(
...
goog.addDependency(
	'../../../ui/volume_bar.js',
	['shaka.ui.VolumeBar'],
	['shaka.ui.Element', 'shaka.ui.Locales', 'shaka.ui.Localization']
);
